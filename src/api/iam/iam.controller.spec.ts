...
describe('IamController', () => {
  ...
  it('should return user when getting user by id', () => {
    expect(service.getUserById(1)).resolves.toEqual(undefined);
  });

  it('should return user when getting user by uuid', () => {
    expect(service.getUserByUuid('uuid')).resolves.toEqual(undefined);
  });

  it('should return user when getting user by username', () => {
    expect(service.getUserByUsername('username')).resolves.toEqual(undefined);
  });

  it('should return user when getting user by email', () => {
    expect(service.getUserByEmail('email')).resolves.toEqual(undefined);
  });
});
